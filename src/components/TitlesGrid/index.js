...
const TitlesGrid = ({ data, loadingIds, singleState, listIsLoading, watchlist, wrapperStyles, children }) => {
  return (
        ...
        <Grid container spacing={4}>
          <Grid md={4} item xs={12}>
            <Card isLoading={listIsLoading}>
              <TitlesList data={data} loadingIds={loadingIds} watchlist={watchlist} />
            </Card>
          </Grid>
